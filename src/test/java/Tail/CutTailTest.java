...
class CutTailTest {
    ...
    void cut() throws IOException {
        CutTail object = new CutTail(new String[]{"text.txt"}, "out.txt");
        ArrayList<String> a = new ArrayList<String>();
              a.add(" Но если он всегда смотрит в лицо смерти, он не будет привязан к вещам и не проявит неуемности и жадности, станет, как я говорил прежде, прекрасным человеком. Что касается размышления о смерти, то Ёсида Кэнко в \"Цурэдзурэ-гуса\"\n" +
              ...
              assertArrayEquals(a, object.cut(5,0));
        a.clear();
        CutTail object1 = new CutTail(new String[]{"text.txt", "tyt.txt"}, "out.txt");
        a.add(  " Но если он всегда смотрит в лицо смерти, он не будет привязан к вещам и не проявит неуемности и жадности, станет, как я говорил прежде, прекрасным человеком. Что касается размышления о смерти, то Ёсида Кэнко в \"Цурэдзурэ-гуса\"\n" +
                " говорит, что монах Синкай имел обыкновение сидеть днями напролет, размышляя о своем конце; несомненно, это очень удобный Для отшельника, но не для воина.\n" +
                "      Ведь тогда он должен был бы пренебречь своим военным долгом и отказаться от пути верности и сыновней почтительности. Самурай же, наоборот, должен постоянно быть занят и общественным, и личным. Но когда бы у него не\n" +
                " появлялось немного времени для себя, чтобы побыть в безмолвии, он не должен забывать возвращаться к вопросу о смерти и размышлять о ней. Разве не сказано, что Кусуноки Масасигэ увещевал своего сына Масацуру всегда помнить о смерти?\n" +
                " Все это предназначено для обучения юного самурая.\n");
        a.add(  "На этом остановилось дело на мосту ночью. Поутру, в гостинице у Московской железной дороги, обнаружилось, что дурак не подурачился, а застрелился. Но \n" +
        ...
        assertArrayEquals(a, object1.cut(5, 0));
        a.clear();
        a.add(" юного самурая.");
        a.add("омненно, дурак.");
        assertArrayEquals(a, object1.cut(0, 15));
    }
